...
toe-ablation. Mechanical loss is the cycle-averaged $P_{mech}$ of Eq.~(5). Heel-strike GRF is the
per-strike peak of the heel-body contact-force magnitude, averaged over all strikes of both feet;
strikes are detected as threshold crossings of the raw, unfiltered heel force.} summarizes the whole-body metrics: relative to toe-ablation, toe-equipped reduces total power by 16.9\% (313.0~W to 260.2~W), CoT by 17.5\% (0.776 to 0.640), and heel-strike
...
\begin{table}[t]
    ...
    Heel-strike GRF [N]  & 970.0 & 1021.1 & $-$5.0 \\
    \bottomrule
    \end{tabular}
\end{table}
