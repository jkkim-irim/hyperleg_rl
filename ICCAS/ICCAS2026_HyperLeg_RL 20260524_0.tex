...
Therefore, the toe-equipped model is relatively slower but deviates less from the prescribed path,
while completing the course in essentially the same time. Fig.~\ref{fig:ttest}(b) and (c) show the
...
and verifying sim-to-real transfer remains future work. In addition, we did not test whether
toe-equipped configurations yield similar benefits on other bipedal platforms; generalization beyond
the proposed system remains an open question.
