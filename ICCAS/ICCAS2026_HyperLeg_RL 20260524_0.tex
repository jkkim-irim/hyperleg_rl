...
path deviation were 25.0\% and 34.0\% smaller at essentially unchanged completion time. Whether this
stems from the toe-equipped model having learned a more conservative policy requires further experiments.
