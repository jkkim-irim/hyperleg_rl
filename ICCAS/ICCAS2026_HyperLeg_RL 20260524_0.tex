...
\abstract{
    ...
    To ensure a fair comparison between configurations with and without active toes, we designed a minimal
    reinforcement-learning (RL) reward function and applied an identical training procedure to both. The
