...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlBaseRunnerCfg):
    ...
    # properly finish wandb run if wandb logger is used
    # RSL-RL's OnPolicyRunner initializes wandb internally but doesn't call wandb.finish()
    # This ensures the run is marked as "finished" instead of "crashed" in wandb
